...
| CRM / MSX tool | `ls ~/Documents/se-kanban-tracker/crm/run-tool.mjs 2>/dev/null` | Opportunities, milestones, customer wins |
...
Only if the CRM tool exists at `~/Documents/se-kanban-tracker/crm/run-tool.mjs`:
